...
1. If certain assumptions re pattern subsumption do not hold ([§11.1](patterns.md#111-general)).
...
1. The order of execution of module initializers in a module ([§23.5.10](attributes.md#23510-the-moduleinitializer-attribute)).
