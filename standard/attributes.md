...
The attribute `ConditionalAttribute` enables the definition of ***conditional method***s and ***conditional attribute class***es.
...
`NotNullAttribute` ([§23.5.7.8](attributes.md#23578-the-notnull-attribute))  | A nullable return value will never be null.
...
`NotNullWhenAttribute` ([§23.5.7.10](attributes.md#235710-the-notnullwhen-attribute))  | A nullable argument will not be null when the method returns the specified `bool` value.
`NotNullIfNotNullAttribute` ([§23.5.7.9](attributes.md#23579-the-notnullifnotnull-attribute))  | A return value is not null if the argument for the specified parameter is not null.
