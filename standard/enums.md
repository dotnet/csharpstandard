...
- `==`, `!=`, `<`, `>`, `<=`, `>=` ([§12.13.6](expressions.md#12136-enumeration-comparison-operators))
- binary `+` ([§12.11.5](expressions.md#12115-addition-operator))
- binary `-` ([§12.11.6](expressions.md#12116-subtraction-operator))
- `^`, `&`, `|` ([§12.14.3](expressions.md#12143-enumeration-logical-operators))
