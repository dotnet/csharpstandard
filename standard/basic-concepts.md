...
-   The *namespace_or_type_name* is the `T` in a *typeof_expression* ([§12.7.16](expressions.md#12716-the-typeof-operator)) of the form `typeof(T)`
...
-   For a type declaration with K type parameters, the unqualified name is the *identifier* specified in the declaration, followed by the *generic_dimension_specifier* ([§12.7.16](expressions.md#12716-the-typeof-operator)) for K type parameters.
