...
Delegates are combined using the binary `+` ([§12.11.5](expressions.md#12115-addition-operator)) and `+=` operators ([§12.22.4](expressions.md#12224-compound-assignment)). A delegate can be removed from a combination of delegates, using the binary `-` ([§12.11.6](expressions.md#12116-subtraction-operator)) and `-=` operators ([§12.22.4](expressions.md#12224-compound-assignment)). Delegates can be compared for equality ([§12.13.9](expressions.md#12139-delegate-equality-operators)).
