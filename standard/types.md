...
A non-enum constructed type shall not be used as an *unmanaged_type* ([§9.8](types.md#98unmanaged-types)).
...
> - A type parameter cannot be used as an *unmanaged_type* ([§9.8](types.md#98unmanaged-types)). *end note*
