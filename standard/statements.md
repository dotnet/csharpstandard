...
A warning is reported if a statement other than a *throw statement*, a *block statement*, or an *empty statement* is unreachable. It is specifically not an error for a statement to be unreachable.
