...
- A conversion is considered to exist if the algorithm of [§12.8.9.2](expressions.md#11782-method-invocations) produces a single best method `M` which is compatible [§20.4] with `D`.
