...
In summary, two `ref` locations are implicitly `scoped`: the `this` parameter of a struct instance method, and every `out` parameter. See [§9.7.2.3](variables.md#9723-parameter-ref-safe-context).
