...
For a `struct` type, within an instance method or instance accessor ([§12.2.1](expressions.md#1221-general)) or instance constructor with a constructor initializer, the `this` keyword behaves exactly as a reference parameter of the struct type ([§12.7.12](expressions.md#12712-this-access)).
...
Within an instance constructor of a struct type, the `this` keyword behaves exactly as an output or reference parameter of the struct type, depending on whether the constructor declaration includes a constructor initializer ([§12.7.12](expressions.md#12712-this-access)).
...
>   - An invocation expression ([§12.7.8](expressions.md#1278-invocation-expressions)) or object creation expression ([§12.7.15.2](expressions.md#127152-object-creation-expressions) that passes the variable as an output parameter.
...
The following rule applies to these kinds of expressions: literals ([§12.7.2](expressions.md#1272-literals)), simple names ([§12.7.4](expressions.md#1274-simple-names)), member access expressions ([§12.7.6](expressions.md#1276-member-access)), non-indexed base access expressions ([§12.7.13](expressions.md#12713-base-access)), `typeof` expressions ([§12.7.16](expressions.md#12716-the-typeof-operator)),  default value expressions ([§12.7.19](expressions.md#12719-default-value-expressions)), and `nameof` expressions ([§12.7.20](expressions.md#12720-nameof-expressions)).
...
The following rules apply to these kinds of expressions: parenthesized expressions ([§12.7.5](expressions.md#1275-parenthesized-expressions)), element access expressions ([§12.7.10](expressions.md#12710-element-access)), base access expressions with indexing ([§12.7.13](expressions.md#12713-base-access)), increment and decrement expressions ([§12.7.14](expressions.md#12714-postfix-increment-and-decrement-operators), [§12.8.6](expressions.md#1286-prefix-increment-and-decrement-operators)), cast expressions ([§12.8.7](expressions.md#1287-cast-expressions)), unary `+`, `-`, `~`, `*` expressions, binary `+`, `-`, `*`, `/`, `%`, `<<`, `>>`, `<`, `<=`, `>`, `>=`, `==`, `!=`, `is`, `as`, `&`, `|`, `^` expressions ([§12.9](expressions.md#129-arithmetic-operators), [§12.10](expressions.md#1210-shift-operators), [§12.11](expressions.md#1211-relational-and-type-testing-operators), [§12.12](expressions.md#1212-logical-operators)), compound assignment expressions ([§12.18.3](expressions.md#12183-compound-assignment)), `checked` and `unchecked` expressions ([§12.7.18](expressions.md#12718-the-checked-and-unchecked-operators)), array and delegate creation expressions ([§12.7.15](expressions.md#12715-the-new-operator)) , and `await` expressions ([§12.8.8](expressions.md#1288-await-expressions)).
...
- For array initializers ([§12.7.15.5](expressions.md#127155-array-creation-expressions)), object initializers ([§12.7.15.3](expressions.md#127153-object-initializers)), collection initializers ([§12.7.15.4](expressions.md#127154-collection-initializers)) and anonymous object initializers ([§12.7.15.7](expressions.md#127157-anonymous-object-creation-expressions)), the definite assignment state is determined by the expansion that these constructs are defined in terms of.
