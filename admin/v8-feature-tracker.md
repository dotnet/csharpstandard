...
nullable reference types ([MS Proposal](https://github.com/dotnet/csharplang/blob/main/proposals/csharp-8.0/nullable-reference-types.md)) |[700](https://github.com/dotnet/csharpstandard/pull/700) | Almost complete | large  | Done | waiting on V7 "Local function declarations" to be merged; waiting on v8 "notnull" feature to be merged 
